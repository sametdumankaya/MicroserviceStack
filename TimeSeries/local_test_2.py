...
env_params = {
    ...
    "bucket_size_msec": 1200000,
    "num_regimes": 20,
    "input_filters": "TARGET=SENSORDOG",
    ...
    "window": 10,
    "timeZone": "US/Pacific",
    "output_stream_name": "OUTPUT_SENSORDOG",
    "process_period": 600,
    "enableBatch": False,
    ...
    "file_url": "https://magi-data.s3.eu-central-1.amazonaws.com/small_hawkeye.csv",
...
df = pd.read_csv(os.getenv("file_url"))
print("Processing the file")
input_target_filter = os.getenv("input_filters", "SENSORDOG")

# t = Thread(target=time_series_operations.time_series_functions.streamDataFrameToRedis,args=(df,   {"TARGET": input_target_filter},))
# t.start()
